@extends('layouts.app')
@section('title') CheckBlockchainАddress.com - list of white and black addresses that includes all blockchains @endsection
...
@section('meta')
    ...
    <meta name="og:title" content="CHECK INFORMATION ABOUT  ADDRESS " />
